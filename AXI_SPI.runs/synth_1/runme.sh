...
HD_PWD='D:/My Files/LTTS/FPGA Training/Projects/AXI_SPI/AXI_SPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Module.tcl
